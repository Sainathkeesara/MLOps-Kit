...
- **Data Drift** — A change in the statistical distribution of input features between training and production data, indicating that the model is making predictions on unfamiliar patterns.
