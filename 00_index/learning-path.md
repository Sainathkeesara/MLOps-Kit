...
- **Containerization** — Package ML code for reproducible deployment. [Primer](../docs/concepts/containerization/0000-primer-containerization.md) — also see the [multistage ONNX Runtime serving container](../docs/concepts/containerization/scripts/2026-07-13-multistage-onnxruntime-serving.py).
...
- **MLflow** — Experiment tracking, model registry, and project packaging. Start with the [primer](../mlflow/notes/0000-primer-mlflow.md), [first run notes](../mlflow/notes/2026-05-27-install-mlflow-first-run.md), and [UI exploration](../mlflow/notes/2026-06-30-exploring-mlflow-ui.md). For a production-ready setup, try the [Postgres + S3 tracking server config](../mlflow/configs/2026-07-14-tracking-server-postgres-s3.yaml).
...
- **Metaflow** — Human-centric ML workflow orchestration. Begin with the [primer](../metaflow/notes/0000-primer-metaflow.md), [install and first flow](../metaflow/snippets/2026-07-06-install-first-flow.py), or [CLI and local dev UI](../metaflow/notes/2026-07-09-explore-cli-local-dev-ui.md). Then move to the [end-to-end experiment script](../metaflow/scripts/2026-07-03-end-to-end-experiment.py) and [logging and artifact tracking script](../metaflow/scripts/2026-07-12-metaflow-logging-artifact-flow.py). For Kubernetes execution, see the [@kubernetes flow](../metaflow/scripts/2026-07-12-kubernetes-flow-metadata-tracking.py). For local dev, use the [DevStack compose manifest](../metaflow/manifests/2026-07-13-metaflow-devstack-compose.yaml).
