...
- **ZenML** — Modular MLOps pipelines with stack abstraction. Start with the [primer](../zenml/notes/0000-primer-zenml.md) and [stack config](../zenml/configs/zenml-stack.yaml). For MLflow integration, see the [MLflow+S3 stack config](../zenml/configs/2026-07-12-zenml-stack-mlflow-s3.yaml).
