...
## Concepts
- [doc] `docs/concepts/containerization/0000-primer-containerization.md` — What containerization is and why it matters in MLOps (L1)
...
- [script] `docs/concepts/experiment-tracking/scripts/tried_comparing_training_runs.py` — Compare training runs with different hyperparameters side by side (L2)
- [snippet] `docs/concepts/experiment-tracking/snippets/tried_experiment_tracking_fundamentals.py` — Practice logging params, metrics, and artifacts with experiment tracking (L2)
- [doc] `docs/concepts/feature-store/0000-primer-feature-store.md` — What a feature store is and why it matters in production ML (L1)
...
- [snippet] `docs/concepts/model-registry/snippets/tried_model_registry_fundamentals.py` — Practice registering, versioning, and aliasing models (L2)
- [doc] `docs/concepts/model-serving/0000-primer-model-serving.md` — What model serving is and why it matters for ML deployment (L1)
- [doc] `docs/concepts/monitoring-drift/0000-primer-monitoring-drift.md` — What monitoring and drift detection is and why it matters for model reliability (L1)
- [doc] `docs/concepts/pipeline-orchestration/0000-primer-pipeline-orchestration.md` — What pipeline orchestration is and why it matters for ML workflows (L1)
...
- [doc] `kubeflow/docs/README.md` — Kubeflow docs directory overview
- [doc] `kubeflow/docs/kubeflow-pipeline-debugging.md` — Diagnose infrastructure failures and pod log issues in KFP pipelines
- [doc] `kubeflow/docs/kubeflow-mlflow-tracking-integration.md` — Wire KFP pipeline components to an in-cluster MLflow tracking server (L4)
...
- [manifest] `kubeflow/manifests/README.md` — Kubeflow manifests directory overview
...
- [notebook] `kubeflow/notebooks/README.md` — Kubeflow notebooks directory overview
...
- [notes] `kubeflow/notes/0000-primer-kubeflow.md` — Kubeflow overview and architecture
...
- [snippet] `kubeflow/snippets/README.md` — Kubeflow snippets directory overview
