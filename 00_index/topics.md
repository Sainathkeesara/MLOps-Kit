...
- **primer:** [Feature Store](../docs/concepts/feature-store/0000-primer-feature-store.md)
  ...
  - [Feature retrieval pipeline](../docs/concepts/feature-store/scripts/feature-retrieval-pipeline.py)
...
- **snippets** (10): [Verify KFP install](../kubeflow/snippets/2026-07-06-verify-kfp-install.py), [Install KFP SDK](../kubeflow/snippets/2026-08-04-install-kfp-sdk.py), [Conditional branching pipeline](../kubeflow/snippets/2026-06-15-conditional-branching-pipeline.py)
- **scripts** (8): [Dynamic parallelism pipeline](../kubeflow/scripts/2026-09-04-dynamic-parallelism-conditional.py), [Kubeflow CI/CD pipeline](../kubeflow/scripts/2026-07-23-kubeflow-ci-cd.sh), [KFP v2 pipeline conditionals](../kubeflow/scripts/2026-08-04-tried-kfp-v2-pipeline-conditionals.py)
- **configs** (3): [Pipeline resources](../kubeflow/configs/pipeline-resources.yaml), [Minimal pipeline](../kubeflow/configs/README.md)
...
- **manifests** (7): [Pipeline CI/CD workflow](../kubeflow/manifests/2026-07-27-kubeflow-pipeline-scaffold-ci-cd.yaml), [CI/CD workflow for scaffold](../kubeflow/manifests/2026-08-02-kubeflow-pipeline-scaffold-ci-cd.yml), [Minimal hello pipeline](../kubeflow/manifests/minimal-hello-pipeline.yaml)
...
- **docs** (11): [W&B integration](../metaflow/docs/metaflow-wandb-integration.md), [Resource management](../metaflow/docs/metaflow-resource-management.md), [Foreach vs @batch](../metaflow/docs/foreach-vs-batch.md)
...
- **scripts** (5): [Experiment comparison + promotion](../mlflow/scripts/experiment-compare-and-promote.py), [End-to-end experiment](../mlflow/scripts/2026-07-06-end-to-end-experiment.py), [Custom experiment tracking](../mlflow/scripts/custom-experiment-tracking-workflow.py)
- **configs** (9): [Sklearn model serving project](../mlflow/configs/sklearn-model-serving-project.yaml), [Tracking server Postgres+S3](../mlflow/configs/2026-07-14-tracking-server-postgres-s3.yaml), [MLflow project config](../mlflow/configs/mlflow-project.yaml)
...
- **configs** (4): [Feature store Redis Parquet config](../feast/configs/2026-08-02-feast-feature-store-redis-parquet.yaml), [Training/serving config](../feast/configs/feature-store-training-serving.yaml), [feature_store.yaml](../feast/configs/feature_store.yaml)
