# MLOps-Kit
> A working engineer's MLOps reference — notes, snippets, and configs for MLflow, Kubeflow, Metaflow, DVC, W&B, Feast, ZenML, ClearML, and Evidently.

![Last commit](https://img.shields.io/github/last-commit/Sainathkeesara/MLOps-Kit)
![Python](https://img.shields.io/badge/Python-60-3776AB?logo=python&logoColor=white)
![Markdown](https://img.shields.io/badge/Markdown-85-000000?logo=markdown&logoColor=white)
...
![Shell](https://img.shields.io/badge/Shell-4-4EAA25?logo=gnu-bash&logoColor=white)
![Files](https://img.shields.io/badge/files-182-blue)
...
Working through first-contact notes and runnable experiments for each tool. Recently added KFP v1 vs v2 DSL migration reference; reusable KFP component factory scripts; Kubeflow docs directory structure; and foundational concept primers for containerization, data versioning, experiment tracking, feature stores, model registry, and model serving.
