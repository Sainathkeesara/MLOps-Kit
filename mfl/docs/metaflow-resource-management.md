...
tool_version: n/a
sources:
  - https://docs.metaflow.org/scaling/envlock
  - https://docs.metaflow.org/scaling/resources
  - https://docs.metaflow.org/scaling/timeout
  - https://docs.metaflow.org/scaling/envlock/pypi
---
...
All three are optional. A flow without them runs in the system Python environment with no resource or time constraints — fine for local prototyping, risky when scaling out.
