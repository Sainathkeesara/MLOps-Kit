...
Designed for local development and CI/CD pipelines.
"""
...
def main():
    ...
    parser.add_argument("--project", default="wandb-pytorch-ci-scaffold")
    ...
    artifact = wandb.Artifact(
        name=f"pytorch-model-{run.id[:8]}",
        type="model",
        description="PyTorch classifier trained on synthetic data",
    )
